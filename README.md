...
- Auth keeps Edge-Git style: Cloudflare Access for `/user/*` + PAT Basic/Bearer for WebDAV (`repo:read`/`repo:write`/`admin`, `duradav-pat:` sha256).
...
- `migrations/0028_dav_volumes.sql` — `dav_volumes` + `dav_collaborators`.
